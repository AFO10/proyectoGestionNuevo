...
class VistaAgregarEmpleado(QDialog):
    ...
    def save_client(self):
        ...
        if (self.controller.agregar_empleado(dni, nombres, apellidoPaterno, apellidoMaterno, telefono)):
            QMessageBox.information(self, 'Éxito', 'Empleado agregado exitosamente.')
        else:
            QMessageBox.warning(self, 'Error', 'Empleado duplicado.')
